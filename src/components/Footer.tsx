      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Balkishan</h3>
            <p className="text-gray-400 mb-4">Full Stack Developer | SIH Winner | Researcher</p>
            <p className="text-gray-400">Creating innovative solutions through technology and research.</p>
          </div>
